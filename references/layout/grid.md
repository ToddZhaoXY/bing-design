...
- Gutter: **24px** (`--serp-gutter`) at all breakpoints
- Grid row height: **88px** (`--serp-row`) with 24px gap
...
| Row Type | Class | Rows | Height | Use |
|---|---|:---:|:---:|---|
| 4-row | `.serp-grid--4row` | 4 × 88px | 424px | Magazine (CGM), Wide Answer |
| 2-row | `.serp-grid--2row` | 2 × 88px | 200px | Short sections |
